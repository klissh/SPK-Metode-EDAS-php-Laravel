...
<div class="max-w-xl mx-auto mt-10 space-y-6">
    ...
    {{-- Header --}}
    <div class="bg-yellow-500 text-white px-6 py-4 rounded-xl shadow flex items-center gap-2">
        <i class="bi bi-pencil-fill"></i>
        <h2 class="text-lg font-semibold">Edit Jenis Analisis</h2>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-6 space-y-6">
        ...
        <form method="POST" action="{{ route('jenis-analisis.update', $jenisAnalisis) }}" class="space-y-5">
            @csrf
            @method('PUT')
